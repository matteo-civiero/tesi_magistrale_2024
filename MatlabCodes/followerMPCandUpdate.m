function [p_tp1, X_F, error, u_opt] = followerMPCandUpdate(...
                            plant, XL, x0, n, m, N, M, q_load, params, obstacles, qi, U_f_old, loadTheta0, crit_dist, fixed_horizon, alg_fmincon, sigma_2, sim_noise)
    ...
    [~, p_pred(:,1)] = modelDynamics(plant, x0, u_opt_reshaped(:,1), sigma_2, sim_noise);
