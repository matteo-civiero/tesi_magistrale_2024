function [p_tp1, X_F, qi, error, u_opt] = followerMPCandUpdate(...
                            plant, XL, x0, n, m, N, params, obstacles, U_f_old, loadTheta, leaderParams)
    ...
    options = optimoptions('fmincon','Algorithm','active-set',...
        ...
        'Display', 'none');
    [u_opt] = fmincon(...
         @(U) followerCostGradientHessian(U, x0, n, m, h, pe, params.vertexes, M, params.initRobotShape, obstacles, C, decay, params.R),...
         U_f_old, G, W + S*x0, [], [], [], [], ...
