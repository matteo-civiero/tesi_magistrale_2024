    ...
    methods
        ...
        function obj = SystemPlotter(...
            ...
            if ~isempty(obj.leaderParams.robotShape)
                ...
                % obj.leaderSafeZone = plot(...
                %     polyshape(x0_l(1)+obj.leaderParams.safe_shape(1,:),...
                %               x0_l(2)+obj.leaderParams.safe_shape(2,:)),...
                %     "LineStyle","--");
            else
                obj.leaderLoadPos = 0;
            end
            ...
            if ~isempty(obj.followerParams.robotShape)
                obj.followerLoadPos = plot(...
                    polyshape(x0_f(1) + obj.followerParams.robotShape(1, 1:obj.followerParams.vertexes),...
                              x0_f(2) + obj.followerParams.robotShape(2, 1:obj.followerParams.vertexes)),...
                    'FaceColor',obj.followerParams.pos_color,'FaceAlpha',0.5);
                % obj.followerSafeZone = plot(...
                %     polyshape(x0_f(1)+obj.followerParams.safe_shape(1,:),...
                %               x0_f(2)+obj.followerParams.safe_shape(2,:)),...
                %     "LineStyle","--");
            else
        ...
        function updateLoadPos(obj, x_now_l, x_now_f, loadTheta) 
            ...
            % obj.leaderSafeZone.Shape.Vertices = (x_now_l(1:2) + Rmat(x_now_l(3))*obj.leaderParams.safe_shape)';
            obj.followerLoadPos.Shape.Vertices = ...
                 (x_now_f(1:2) + Rmat(x_now_f(3))*obj.followerParams.initRobotShape)';
            % obj.followerSafeZone.Shape.Vertices = (x_now_f(1:2) + Rmat(x_now_f(3))*obj.followerParams.safe_shape)';
